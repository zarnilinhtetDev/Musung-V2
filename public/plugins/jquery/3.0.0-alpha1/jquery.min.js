...
!(function (a, b) {
    ...
    n.extend({
                        ...
                        return n
                            .Deferred(function (a) {
                                c[0][3].add(
                                    ...
                                    c[1][3].add(
                                        h(0, a, n.isFunction(b) ? b : G)
                                    ),
                                    c[2][3].add(
                                        h(0, a, n.isFunction(d) ? d : H)
                                    );
                            })
                            .promise();
                    },
        ...
        when: function (a) {
            var b,
                ...
                i = function (a, b, c) {
                    return function (d) {
                        (b[a] = this),
                            (c[a] =
                                arguments.length > 1 ? e.call(arguments) : d),
                            c === j
                                ? h.notifyWith(b, c)
                                : --g || h.resolveWith(b, c);
                    };
            ...
            if (f > 1)
                for (
                    j = new Array(f), k = new Array(f), l = new Array(f);
                    f > c;
                    c++
                )
                ...
                if (void 0 !== d) {
                    if (void 0 !== b) {
                        n.isArray(b)
                            ? (b = b.map(n.camelCase))
                            : ((b = n.camelCase(b)),
                              (b = b in d ? [b] : b.match(E) || [])),
                            (c = b.length);
                        while (c--) delete d[b[c]];
                    }
                    (void 0 === b || n.isEmptyObject(d)) &&
            ...
            data: function (a, b) {
                ...
                if (void 0 === a) {
                    if (
                        this.length &&
                        ((e = N.get(f)),
                        1 === f.nodeType && !M.get(f, "hasDataAttrs"))
                    ) {
                        c = g.length;
                        while (c--)
                            g[c] &&
    ...
    function ua(a, b) {
        ...
        if (1 === b.nodeType) {
            ...
            N.hasData(a) &&
                ((h = N.access(a)), (i = n.extend({}, h)), N.set(b, i));
        }
    }
    function va(a, b) {
        var c = b.nodeName.toLowerCase();
        ...
        if (
            ...
            for (h = n.map(aa(e, "script"), sa), i = h.length; o > m; m++)
                (j = e),
                    m !== p &&
                        ((j = n.clone(j, !0, !0)),
                        i && n.merge(h, aa(j, "script"))),
                    c.call(a[m], j, m);
            if (i)
                for (
                    k = h[h.length - 1].ownerDocument, n.map(h, ta), m = 0;
                    i > m;
                    m++
                )
                    (j = h[m]),
    ...
    n.extend({
        ...
        clone: function (a, b, c) {
            ...
            if (b)
                if (c)
                    for (
                        f = f || aa(a), g = g || aa(h), d = 0, e = f.length;
                        e > d;
                        d++
                    )
                        ua(f[d], g[d]);
        ...
        n.fn.extend({
            ...
            empty: function () {
                for (var a, b = 0; null != (a = this[b]); b++)
                    1 === a.nodeType &&
                        (n.cleanData(aa(a, !1)), (a.textContent = ""));
                return this;
            },
            clone: function (a, b) {
                return (
    ...
    (n.Tween = Oa),
        (Oa.prototype = {
            ...
            cur: function () {
                ...
                return a && a.get
                    ? a.get(this)
                    : Oa.propHooks._default.get(this);
            },
            run: function (a) {
                var b,
                ...
                if (3 !== f && 8 !== f && 2 !== f)
                    return "undefined" == typeof a.getAttribute
                        ...
                        : ((1 === f && n.isXMLDoc(a)) ||
                              ...
                              (e =
                                  n.attrHooks[b] ||
                                  (n.expr.match.bool.test(b) ? $a : void 0))),
                          void 0 !== c
                              ? null === c
                ...
                ? ((e = b.jsonpCallback =
                  ...
                  d.always(function () {
                      void 0 === f ? n(a).removeProp(e) : (a[e] = f),
                          b[e] &&
                              ((b.jsonpCallback = c.jsonpCallback), Eb.push(e)),
